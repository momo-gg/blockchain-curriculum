...
Create (System Program)
  → Allocate space + fund rent
  → Assign owner program
  → Use/modify during instructions
  → Close when done (rent refunded)
```
