...
│                                                                      │
│   COMPUTE UNITS                                                     │
│   Default: 200,000 per transaction                                  │
│   Maximum: 1,400,000 (with priority fee)                           │
│   Per instruction: varies by operation                              │
│                                                                      │
│   TRANSACTION SIZE                                                  │
│   Maximum: ~1,232 bytes (legacy); v0 differs with ALTs              │
│   Includes: signatures, addresses, instructions, data               │
│                                                                      │
│   ACCOUNT DATA                                                      │
│   Maximum per account: 10 MB                                        │
│   Maximum realloc per instruction: 10 KB                            │
│                                                                      │
│   ACCOUNTS PER TRANSACTION                                          │
│   Legacy messages: up to 64 account keys                            │
...
|-----------|-----------------|
| Basic instruction | 200-500 |
| SHA256 hash | 100-300 |
| Ed25519 verify | 7,000+ |
| Account creation (CPI) | 10,000+ |
