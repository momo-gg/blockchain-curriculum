...
```
┌─────────────────────────────────────────────────────────────────────┐
│                    Accounts = Storage Lockers                        │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│   ┌─────────────┐  ┌─────────────┐  ┌─────────────┐                │
│   │ Locker #1   │  │ Locker #2   │  │ Locker #3   │                │
│   │ Owner: You  │  │ Owner: App  │  │ Owner: Token│                │
│   │ Data: $500  │  │ Data: Game  │  │ Data: 1000  │                │
│   │             │  │  state      │  │  USDC       │                │
│   └─────────────┘  └─────────────┘  └─────────────┘                │
│                                                                      │
│   Every locker has:                                                  │
│   • An address (how to find it)                                      │
...
Accounts must pay "rent" to exist on Solana:

| Account Size | Rent-Exempt Amount | Notes |
|--------------|-------------------|-------|
| Minimum (0 bytes) | ~0.00089 SOL | Just the header |
| Token Account | ~0.00203 SOL | 165 bytes |
| 1 KB | ~0.00796 SOL | Small data |
| 10 KB | ~0.0709 SOL | Medium data |
...
│   └── Credit lamports to the account                                │
│                                                                      │
│   SPECIAL CASES:                                                    │
│   ├── System Program owns "wallet" accounts                         │
│   ├── BPF Loader owns program accounts                              │
