...
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│   User wants to: Swap USDC for SOL, then stake the SOL              │
│                                                                      │
│   ┌─────────────┐    ┌─────────────┐    ┌─────────────┐            │
│   │ DEX Program │───►│Token Program│───►│Staking Prog │            │
│   │             │    │             │    │             │            │
│   │ Swap USDC   │    │ Transfer    │    │ Stake SOL   │            │
│   │ for SOL     │    │ tokens      │    │             │            │
│   └─────────────┘    └─────────────┘    └─────────────┘            │
│                                                                      │
│   One transaction, three programs, all atomic                        │
...
│        ▼                                                             │
│   ┌─────────────┐                                                   │
│   │ Your Program│ ←── Called by user                                │
│   │  (Program A)│                                                   │
│   └──────┬──────┘                                                   │
│          │ CPI                                                       │
│          ▼                                                           │
│   ┌─────────────┐                                                   │
│   │Token Program│ ←── Called by Program A                          │
│   │  (Program B)│                                                   │
│   └──────┬──────┘                                                   │
│          │ CPI                                                       │
│          ▼                                                           │
│   ┌─────────────┐                                                   │
│   │ AMM Program │ ←── Called by Token Program (rare)               │
│   │  (Program C)│                                                   │
│   └─────────────┘                                                   │
│                                                                      │
│   All execute atomically — all succeed or all fail                  │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
```
...
User → Program A → Program B → Program C → Program D
                         ↓
...
Learn about the SPL Token Program — the standard for tokens on Solana.

→ [4.5 Tokens: SPL Token Program](./4.5-spl-token-program.md)
