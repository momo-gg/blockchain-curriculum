...
> *"NFTs on Solana are just tokens with supply of 1 and 0 decimals — plus metadata."*

---

## Why This Matters

Non-Fungible Tokens (NFTs) have become a major use case for blockchains. Solana's low fees and fast finality make it ideal for NFT applications — from art collections to gaming assets to membership passes. Understanding how NFTs work on Solana, particularly through Metaplex, is essential for building NFT-related products.
...
Primary Sale:
  Buyer pays 1 SOL
  Creator receives 1 SOL (100%)

Secondary Sale:
  Seller lists for 2 SOL
  Buyer pays 2 SOL
  ├── Creator receives 0.1 SOL (5% royalty)
  └── Seller receives 1.9 SOL
...
```
REGULAR NFT:
  Cost: ~0.012 SOL per NFT (rent for accounts)
  10,000 NFTs = 120 SOL

COMPRESSED NFT:
  Cost: ~0.00005 SOL per NFT
  10,000 NFTs = 0.5 SOL
