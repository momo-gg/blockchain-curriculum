...
│   ├── Vue / Nuxt                  ├── Flutter                       │
│   └── Plain JavaScript            └── Native iOS/Android            │
│                                                                      │
│   BACKEND CLIENTS                 CLI / SCRIPTS                     │
│   ├── Node.js                     ├── TypeScript                    │
│   ├── Python                      ├── Rust                          │
│   └── Rust                        └── Shell + solana-cli            │
│                                                                      │
│                      SDK OPTIONS                                    │
│   ┌─────────────────────────────────────────────────────────────┐   │
│   │ @solana/web3.js    - Official JavaScript SDK                │   │
│   │ @coral-xyz/anchor  - Anchor client (wraps web3.js)          │   │
│   │ @solana/spl-token  - Token operations                       │   │
│   │ solana-py          - Python SDK                              │   │
│   │ solana-sdk (Rust)  - Native Rust client                     │   │
│   └─────────────────────────────────────────────────────────────┘   │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
```
...
│                                                                      │
│   Best of both:                                                     │
│   ✓ Direct signing (no trust required)                             │
│   ✓ Cached/indexed reads (fast)                                    │
│   ✓ Can build custom indexes                                       │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
```
...
|----------|-----------|----------|
| **Helius** | 100k requests/day | DeFi, low-latency |
| **Quicknode** | Limited | Enterprise, reliability |
| **Triton** | Limited | High-volume |
| **Alchemy** | Generous | Multi-chain apps |
