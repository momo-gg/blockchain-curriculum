# 5.2 @solana/web3.js Deep Dive

> *"web3.js is your toolbox for everything Solana — connections, transactions, accounts, and more."*
...
│   └── Single operation with program, accounts, data                │
│                                                                      │
│   SystemProgram                                                     │
│   └── Built-in program for basic operations                        │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
```
...
```
Get account → Deserialize bytes → Render UI
```
...
1. **Connection is your RPC client** — configure commitment levels
2. **Keypair for signing** — secure your secret keys
3. **PublicKey is everywhere** — addresses, program IDs, PDAs
4. **Transaction contains instructions** — build, sign, send
5. **Use VersionedTransaction for ALTs** — more accounts per tx
6. **Set compute budget** — when you need more CUs
7. **Simulate before sending** — catch errors early
8. **Subscribe for real-time** — WebSocket updates

---

## Next

Learn how to build transactions for different scenarios.

→ [5.3 Transaction Building](./5.3-transaction-building.md)
