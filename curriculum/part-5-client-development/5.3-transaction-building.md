...
| Limit | Value | Impact |
|-------|-------|--------|
| Max size | 1,232 bytes | Limits accounts and data |
| Max accounts | 64 (256 with ALT) | Limits instruction complexity |
...
→ [5.4 Wallet Integration](./5.4-wallet-integration.md)
