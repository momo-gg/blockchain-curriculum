---
title: "3.2 How Solana Works"
description: "Learn about 3.2 How Solana Works in the Solana onboarding curriculum."
---
...
B: "Leader receives"
A -> B
C: "Transaction ordered"
B -> C
D: "Transaction executed"
C -> D
E: "Block created"
D -> E
F: "Block propagated"
...
B -> B: "Gulf Stream: skip the waiting room"
C -> C: "PoH: stamp with verifiable time"
D -> D: "Sealevel: process in parallel"
E -> E: "Pipelining: like a CPU pipeline"
F -> F: "Turbine: spread like gossip"
G -> G: "Tower BFT: validators vote"
H -> H: "Cloudbreak: save to disk fast"
```
...
direction: right
A: "User clicks Swap"
B: "Wallet signs transaction"
A -> B
C: "RPC forwards to current leader"
B -> C
D: "Leader executes in Sealevel"
C -> D
E: "Block propagates via Turbine"
D -> E
F: "Validators vote Tower BFT"
E -> F
G: "Confirmation returned to client"
F -> G
...
style.animated: true
direction: down
Traditional.label: "Traditional (Client-Server)"
Traditional: {
  C1: "Computer 1"
  CS: "Central Server"
  C1 -> CS
...
style.animated: true
direction: right
A: "New validator starts"
B: "Contacts seed nodes"
A -> B
C: "Receives list of active peers"
B -> C
D: "Connects to peers"
C -> D
E: "Learns about more peers via gossip"
D -> E
F: "Has many connections"
E -> F
...
A1: "Genesis configuration finalized"
A1 -> A
A2: "Founding validators set up hardware"
A2 -> A
A3: "Testnet runs"
A3 -> A

B1: "All validators start simultaneously"
B1 -> B
B2: "Load identical genesis configuration"
B2 -> B
B3: "First PoH tick begins"
B3 -> B

C1: "Leaders selected from genesis validator set"
C1 -> C
C2: "First transactions processed"
C2 -> C

D1: "New validators can join"
D1 -> D
D2: "Stake delegation enabled"
D2 -> D
...
style.animated: true
direction: right
Protocol.label: "Protocol (Rules)"
Protocol: {
  SP: "Solana Protocol"
  HP: "HTTP Protocol"
}

Implementations.label: "Clients (Implementations)"
Implementations: {
  A: "Agave\nRust, by Anza"
  F: "Firedancer\nC, by Jump"
  S: "Sig\nZig, by Syndica"
...
Browsers.label: "Browser Implementations"
Browsers: {
  CH: "Chrome"
  FF: "Firefox"
  SF: "Safari"
...
style.animated: true
direction: down
O: "Original Solana Labs client"
A: "Agave by Anza\nmainnet client"
O -> A
F: "Firedancer by Jump Crypto\nnew client in C"
O -> F
S: "Sig by Syndica\nZig implementation"
O -> S
...
direction: down
Today: {
  A: "Agave\nprimary mainnet client"
  F: "Firedancer\nunder active development"
}

Future.label: "Future: Multiple Production Clients"
Future: {
  AB: "Agave has a bug"
  FR: "Firedancer validators keep running"
  AB -> FR
  FB: "Firedancer has a bug"
  AR: "Agave validators keep running"
  FB -> AR
  N: "Network stays live"
  FR -> N
  AR -> N
}
...
A1: "Feature coded, tested, audited"
A1 -> A
A2: "Merged with feature flag disabled"
A2 -> A

B1: "SIMD written"
B1 -> B
B2: "Community discussion"
B2 -> B
B3: "Validators signal readiness"
B3 -> B

C1: "Feature flag enabled after sufficient stake upgrades"
C1 -> C
C2: "Activation occurs at specific slot"
C2 -> C

D1: "Blocks valid before activation slot"
D1 -> D
D2: "Blocks invalid after activation slot"
D2 -> D
...
B: "Split into shreds"
A -> B
C: "Add erasure coding"
B -> C
D: "Reconstruct from subset of shreds"
C -> D
...
B: "Conflict Analysis\nBuild graph: transaction → accounts accessed"
A -> B
C: "Parallel Scheduling\nNon-conflicting batches run on different CPU cores"
B -> C
D1: "Core 1\nBatch A"
C -> D1
D2: "Core 2\nBatch B"
