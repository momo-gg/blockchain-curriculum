...
style.animated: true
direction: down
Lockers.label: "Accounts = Storage Lockers"
Lockers: {
  L1: "Locker #1\nOwner: You\nData: 500 USD"
  L2: "Locker #2\nOwner: App\nData: Game state"
  L3: "Locker #3\nOwner: Token\nData: 1000 USDC"
...
Properties.label: "Every locker has:"
Properties: {
...
style.animated: true
direction: down
A: "Seeds + Program ID + Bump"
B: "find_program_address"
A -> B
C: "PDA Address"
B -> C
...
Problem: {
  P1: "Regular accounts need\na private key to sign"
  P2: "Programs don't have\nprivate keys"
  P3: "How can a program\ncontrol an account?"
}

Solution.label: "SOLUTION"
Solution: {
  S1: "PDAs derived from\nseeds + program ID"
  S2: "They're off the curve\nno valid private key"
  S3: "Program can sign for them\nusing invoke_signed"
}
