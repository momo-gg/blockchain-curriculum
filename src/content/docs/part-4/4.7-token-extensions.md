---
title: "4.7 Token Extensions (Token-2022)"
description: "Learn about 4.7 Token Extensions (Token-2022) in the Solana onboarding curriculum."
---

> *"Token-2022 adds features the original token program couldn't have — transfer fees, confidential transfers, and more."*

---

## Why This Matters

The original SPL Token program is immutable — once deployed, it can't be changed. As the ecosystem evolved, new requirements emerged: on-chain royalties, transfer hooks, confidential amounts. Token-2022 (also called Token Extensions) was built to address these needs while remaining compatible with the original.
...
```
ADVANTAGES:
  ✅ Native features (no custom programs)
  ✅ Audited, maintained by the Solana ecosystem
  ✅ Ecosystem support growing
  ✅ Lower complexity for common patterns

CONSIDERATIONS:
  ⚠️ Not all wallets/dApps support yet
  ⚠️ Larger account sizes (more rent)
  ⚠️ Some extensions increase compute cost
  ⚠️ Need to check compatibility
```
...
1. **Token-2022 extends SPL Token** — same base, new features
2. **Extensions are opt-in** — choose what you need
...
7. **Check ecosystem support** before using — not universal yet
