---
title: "5.1 Client Architectures"
description: "Learn about 5.1 Client Architectures in the Solana onboarding curriculum."
---
...
Pros: {
  P1: "✓ Simple architecture"
  P2: "✓ Direct blockchain access"
  P3: "✓ Real-time data"
}

Cons: {
  C1: "✗ Rate limits on public RPCs"
  C2: "✗ No caching layer"
  C3: "✗ Wallet required in browser"
}
...
Pros: {
  P1: "✓ Caching for reads"
  P2: "✓ Rate limit management"
  P3: "✓ Can use private RPC"
  P4: "✓ Server-side signing possible"
}

Cons: {
  C1: "✗ Additional infrastructure"
  C2: "✗ Potential single point of failure"
  C3: "✗ Added latency"
}
...
Benefits.label: "Best of both:"
Benefits: {
  B1: "✓ Direct signing - no trust required"
  B2: "✓ Cached/indexed reads - fast"
  B3: "✓ Can build custom indexes"
}
