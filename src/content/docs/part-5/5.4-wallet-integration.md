---
title: "5.4 Wallet Integration"
description: "Learn about 5.4 Wallet Integration in the Solana onboarding curriculum."
---
...
- Avoid “blind signing” flows unless the wallet explicitly supports it and the user understands.
...
```
Connect wallet → Sign message → Verify signature → Create session
```
