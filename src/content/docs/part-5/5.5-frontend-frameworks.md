---
title: "5.5 Frontend Frameworks"
description: "Learn about 5.5 Frontend Frameworks in the Solana onboarding curriculum."
---

> *"The best dApp feels like a regular app — users shouldn't know there's a blockchain behind it."*
...
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│   REACT ECOSYSTEM                  OTHER FRAMEWORKS                 │
│   ├── Next.js (Recommended)        ├── Vue + Nuxt                   │
│   ├── Create React App             ├── Svelte + SvelteKit          │
│   ├── Vite + React                 └── Angular                     │
│   └── Remix                                                         │
│                                                                      │
...
```
Server: fetch public data, pre-render pages
Client: connect wallet, sign, send transactions
```

Keep wallet interactions on the client, and push read-only data to the server.
...
1. **Use Next.js App Router** — best DX for Solana dApps
2. **React Query for data** — caching, refetching, optimistic updates
3. **Separate client/server** — fetch static data server-side
4. **Handle all states** — loading, error, empty, success
5. **Optimistic updates** — immediate feedback
6. **Toast notifications** — transaction status
7. **Mobile responsive** — wallet UX varies on mobile
8. **API routes for RPC** — proxy private endpoints
